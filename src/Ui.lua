...
function UI.Init(Config, Dependencies)
    ...
    assert(
        ...
        and type(Dependencies.NeverLose)
            == "table",
    ...
    local Success,
        Result =
            xpcall(function()
                ...
                local FreecamStatus =
                    FreecamSection:AddLabel(
                        "Status: OFF",
                        true
                    )

                local function SetFreecamStatus(IsEnabled)
                    if Destroyed then
                        return
                    end

                    FreecamStatus:SetText(
                        IsEnabled
                        and "Status: ON"
                        or "Status: OFF"
                    )
                ...
                ProjectSection:AddLabel(
                    "Runtime: ESP + Corpse ESP + Freecam",
                    true
                )
